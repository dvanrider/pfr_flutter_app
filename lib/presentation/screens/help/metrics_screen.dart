        ...
        child: Column(
          ...
          children: [
            ...
            _buildSupportingMetric(
              ...
              'Positive (green) = under budget (favorable), Negative (red) = over budget (unfavorable)',
            ),
            const Divider(height: 24),
            _buildSupportingMetric(
              theme,
              ...
              'Positive (green) = exceeded target (favorable), Negative (red) = below target (unfavorable)',
            ),
            const Divider(height: 24),
            _buildSupportingMetric(
              theme,
              ...
              'Shows variance as a percentage of the original budget for easier comparison',
            ),
          ],
        ),
      ),
